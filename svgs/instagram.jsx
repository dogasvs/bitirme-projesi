export default function InstagramSvg() {
  return (
    ...
    <rect x="2" y="2" width="28" height="28" rx="6" fill="url(#paint0_radial_4_603)"/>
    <rect x="2" y="2" width="28" height="28" rx="6" fill="url(#paint1_radial_4_603)"/>
    <rect x="2" y="2" width="28" height="28" rx="6" fill="url(#paint2_radial_4_603)"/>
    ...
    <defs>
    <radialGradient id="paint0_radial_4_603" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(12 23) rotate(-55.3758) scale(25.5196)">
    <stop stopColor="#B13589"/>
    <stop offset="0.79309" stopColor="#C62F94"/>
    <stop offset="1" stopColor="#8A3AC8"/>
    </radialGradient>
    <radialGradient id="paint1_radial_4_603" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(11 31) rotate(-65.1363) scale(22.5942)">
    <stop stopColor="#E0E8B7"/>
    <stop offset="0.444662" stopColor="#FB8A2E"/>
    <stop offset="0.71474" stopColor="#E2425C"/>
    <stop offset="1" stopColor="#E2425C" stopOpacity="0"/>
    </radialGradient>
    <radialGradient id="paint2_radial_4_603" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(0.500002 3) rotate(-8.1301) scale(38.8909 8.31836)">
